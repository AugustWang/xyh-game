%% $Id: u.erl 13280 2014-06-21 10:14:57Z rolong $
...
-export([
    ...
    ,update_xyh_bin/0
    ,commit_xyh_bin/0
    ,update_xyh_protocol/0
    ,commit_xyh_protocol/0
    ,db/0
    ,db_truncate/0
    ,print_map/1
    % -- tracer --
...
update_xyh_protocol() ->
    Rt = os:cmd("svn update /home/xyh/web/data/protocol --username myserver --password 01 --no-auth-cache"),
    os:cmd("chown www:www /home/xyh/web/data/protocol/erlang/*.hrl"),
    os:cmd("chown www:www /home/xyh/web/data/protocol/erlang/*.erl"),
    os:cmd("chown www:www /home/xyh/web/data/protocol/c++/*.h"),
    os:cmd("chown www:www /home/xyh/web/data/protocol/c++/*.cpp"),
    Rt.

commit_xyh_protocol() ->
    os:cmd("svn add -q /home/xyh/web/data/protocol/erlang/*.*"),
    os:cmd("svn add -q /home/xyh/web/data/protocol/c++/*.*"),
    os:cmd("svn ci -m 'auto commit' /home/xyh/web/data/protocol/ --username myserver --password 01 --no-auth-cache").

update_xyh_bin() ->
    Rt = os:cmd("svn update /home/xyh/web/data/bin --username myserver --password 01 --no-auth-cache"),
    os:cmd("chown www:www /home/xyh/web/data/bin/*.bin"),
    os:cmd("chown www:www /home/xyh/web/data/bin/*.str"),
    Rt.

commit_xyh_bin() ->
    os:cmd("svn add -q /home/xyh/web/data/bin/*.*"),
    os:cmd("svn ci -m 'auto commit' /home/xyh/web/data/bin/ --username myserver --password 01 --no-auth-cache").
...
%%     Rt.
update_client_data() ->
    Rt = os:cmd("svn update /home/mst_web/web/simple_xls --username myserver --password 01 --no-auth-cache"),
    os:cmd("chown www:www /home/mst_web/web/simple_xls/*.txt"),
    Rt.


%% commit_client_data() ->
%%     os:cmd("svn add -q /home/default/web/simple_xls/*.txt"),
%%     os:cmd("svn ci -m 'auto commit' /home/default/web/simple_xls --username myserver --password 01 --no-auth-cache").
commit_client_data() ->
    os:cmd("svn add -q /home/mst_web/web/simple_xls/*.txt"),
    os:cmd("svn ci -m 'auto commit' /home/mst_web/web/simple_xls --username myserver --password 01 --no-auth-cache").

update_client_pt() ->
    Rt = os:cmd("svn update /home/mst_client_data --username myserver --password 01 --no-auth-cache"),
    os:cmd("chown -R www:www /home/mst_client_data"),
    Rt.

commit_client_pt() ->
    os:cmd("svn add -q /home/mst_client_data/c/* /home/mst_client_data/s/* /home/mst_client_data/vo/*"),
    os:cmd("svn ci -m 'auto commit' /home/mst_client_data --username myserver --password 01 --no-auth-cache").

update_erlang_pt() ->
    Rt = os:cmd("svn update /home/myserver/src/pt --username myserver --password 01 --no-auth-cache"),
    os:cmd("chown www:www /home/myserver/src/pt/pt_pack.txt"),
    os:cmd("chown www:www /home/myserver/src/pt/pt_unpack.txt"),
    Rt.

commit_erlang_pt() ->
    os:cmd("chown www:www /home/myserver/src/pt/pt_pack*"),
    os:cmd("chown www:www /home/myserver/src/pt/pt_unpack*"),
    os:cmd("svn ci -m 'auto commit' /home/myserver/src/pt --username myserver --password 01 --no-auth-cache").

update_erlang_data() ->
    Rt = os:cmd("svn update /home/myserver/src/data --username myserver --password 01 --no-auth-cache"),
...
commit_erlang_data() ->
    ...
    os:cmd("svn ci -m 'auto commit' /home/myserver/src/data --username myserver --password 01 --no-auth-cache").

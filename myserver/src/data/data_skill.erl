...
get(11) -> [{trigger, {skill_atked,{rate,35}}}, {target, enemy}, {cmd, [{set_buff,{disable_skill,ok,5,2,ok}}]}];
...
get(23) -> [{trigger, {init,ok}}, {target, {enemy,all}}, {cmd, [{set_def,{'-',150}}]}];
get(24) -> [{trigger, {die,ok}}, {target, enemy}, {cmd, [{set_buff,{horror,ok,3,5,ok}}]}];
get(25) -> [{trigger, {active,ok}}, {target, {friend,2,rand}}, {cmd, [{set_buff,{add_atk,{'*',0.6},2,3,atk}}]}];
get(26) -> [{trigger, {atk,ok}}, {target, enemy}, {atk, 1.15}];
get(27) -> [{trigger, {wake,{hp_ratio_less,40}}}, {target, {enemy,all,col}}, {cmd, [{set_buff,{dizzy,ok,2,1,ok}}]}, {atk, 1.8}];
...
get(47) -> [{trigger, {active,ok}}, {target, {friend,3,hp_live_min}}, {atk, 0.7}];
...
get(56) -> [{trigger, {wake,{hp_ratio_less,30}}}, {target, {enemy,all}}, {cmd, [{set_buff,{ice,{rate, 100},1,12,ok}}]}, {atk, 1.25}];
get(57) -> [{trigger, {active,ok}}, {target, {enemy,1}}, {cmd, [{set_buff,{disable_skill,ok,5,2,ok}}]}, {atk, 1.5}];
get(58) -> [{trigger, {active,ok}}, {target, {enemy,all}}, {atk, 0.75}];
get(59) -> [{trigger, {active,ok}}, {target, {friend,3,hp_live_min}}, {cmd, [{add_hp,{cure_sum,3}}]}];
get(60) -> [{trigger, {active,ok}}, {target, {enemy,all,front_row}}, {atk, {unit_mul,0.7}}];
...
get(65) -> [{trigger, {wake,{hp_ratio_less,30}}}, {target, self}, {cmd, [{add_hp,{'*',0.5}},{set_buff,{set_def,{'*',0.3},99,16,pre_atked}}]}];
get(66) -> [{trigger, {wake,{hp_ratio_less,50}}}, {target, {enemy,all,front_row}}, {atk, {unit_div,4}}];
get(67) -> [{trigger, {wake,{hp_ratio_less,50}}}, {target, self}, {cmd, [{add_hp,{'*',0.2}},{set_buff,{set_atk,{'*',0.5},99,14,pre_atked}}]}];
get(68) -> [{trigger, {wake,{hp_ratio_less,50}}}, {target, {enemy,1,behind}}, {atk, 3}];
get(69) -> [{trigger, {wake,{hp_ratio_less,30}}}, {target, self}, {cmd, [{set_buff,{super,ok,3,15,atk}}]}];
get(70) -> [{trigger, {wake,{hp_ratio_less,40}}}, {target, {enemy,all}}, {cmd, [{add_hp,{'*',-0.15}}]}];
get(71) -> [{trigger, {wake,{hp_ratio_less,30}}}, {target, {enemy,1,rand}}, {atk, {weight,[{30,1.5},{70,4}]}}];
get(72) -> [{trigger, {init,ok}}, {target, {enemy,all}}, {cmd, [{set_crit,{'-',100}}]}];
get(73) -> [{trigger, {init,ok}}, {target, self}, {cmd, [{set_def,{'+',400}}]}];
get(74) -> [{trigger, {init,ok}}, {target, self}, {cmd, [{set_dod,{'+',200}}]}];
get(75) -> [{trigger, {init,ok}}, {target, self}, {cmd, [{set_crit,{'+',100}}]}];
get(76) -> [{trigger, {init,ok}}, {target, self}, {cmd, [{set_pun,{'+',300}}]}];
...
get(80) -> [{trigger, {after_kill,ok}}, {target, self}, {cmd, [{set_buff,{set_atk,{original, 0.25,9999},1,18,after_kill}}]}];
...
get(83) -> [{trigger, {active,ok}}, {target, {enemy,all,front_row}}, {cmd, [{set_buff,{ice,{rate, 10},1,12,ok}}]}, {atk, 1.3}];
get(84) -> [{trigger, {atk,ok}}, {target, enemy}, {cmd, [{add_ice_rate,{5, 40}}]}];
get(85) -> [{trigger, {wake,{hp_ratio_less,30}}}, {target, {enemy,all}}, {cmd, [{set_buff,{ice,{rate, 20},1,12,ok}}]}, {atk, 1.3}];
get(86) -> [{trigger, {active,ok}}, {target, {enemy,all,col}}, {atk, 1.1}];
get(87) -> [{trigger, {atk,ok}}, {target, enemy}, {cmd, [{set_buff,{around,{rate, 8},2,13,ok}}]}];
get(88) -> [{trigger, {wake,{hp_ratio_less,30}}}, {target, {enemy,1,col_leader}}, {atk, 4}];
get(89) -> [{trigger, {atked,{rate,7}}}, {target, enemy}, {cmd, [{set_buff,{dizzy,ok,1,1,ok}}]}];
get(91) -> [{trigger, {active,ok}}, {target, {enemy,1,col}}, {atk, 2}];
get(92) -> [{trigger, {init,ok}}, {target, self}, {cmd, [{set_pun,{'+',280}}]}];
get(93) -> [{trigger, {wake,{hp_ratio_less,60}}}, {target, {enemy,all}}, {atk, 2}];
get(94) -> [{trigger, {active,ok}}, {target, {enemy,1}}, {atk, 2.2}];
get(95) -> [{trigger, {init,ok}}, {target, self}, {cmd, [{set_dod,{'+',200}}]}];
get(96) -> [{trigger, {wake,{hp_ratio_less,50}}}, {target, {enemy,1}}, {atk, 3.8}];
get(97) -> [{trigger, {active,ok}}, {target, {enemy,all}}, {atk, 0.6}];
get(98) -> [{trigger, {init,ok}}, {target, self}, {cmd, [{set_crit,{'+',100}}]}];
...
get(1046) -> [{trigger, {active,ok}}, {target, {friend,3,hp_live_min}}, {atk, 0.5}];
...
get(1052) -> [{trigger, {active,ok}}, {target, {enemy,1}}, {cmd, [{set_buff,{dizzy,ok,1,13,ok}}]}, {atk, 2}];
...
get(1055) -> [{trigger, {wake,{hp_ratio_less,40}}}, {target, {enemy,all,col}}, {cmd, [{set_buff,{dizzy,ok,2,1,ok}}]}, {atk, 1.8}];
...
get(2046) -> [{trigger, {active,ok}}, {target, {friend,3,hp_live_min}}, {atk, 0.6}];
...
get(3046) -> [{trigger, {active,ok}}, {target, {friend,3,hp_live_min}}, {atk, 1}];
...
get(3084) -> [{trigger, {init, ok}}, {target, {friend,all}}, {cmd, [{set_buff,{add_atk,{'*',0.6},3,3,atk}}]}];
get(3085) -> [{trigger, {atked,{rate,7}}}, {target, enemy}, {cmd, [{set_buff,{dizzy,ok,1,1,ok}}]}];
get(3086) -> [{trigger, {active,ok}}, {target, {enemy,1}}, {cmd, [{set_buff,{horror,ok,1,5,ok}}]}, {atk, 2}];
...
get(3091) -> [{trigger, {wake,{hp_ratio_less,20}}}, {target, {enemy,all,col}}, {cmd, [{set_buff,{dizzy,ok,2,1,ok}}]}, {atk, 2}];

...
log_fun_for_server(_Mod, _Line, _Level, _P) ->
    case _Level of
        error ->
            {Msg, Params} = _P(),
            Msg1 = "[~w:~w ~w] " ++ Msg ++ "~n",
...
%% 		false->
%% 			MySQLHostAddress = login_server:ini_ReadString( "GameServerSetup.txt", "MySQLHostAddress", "localhost" ),
%% 			MySQLUserName = login_server:ini_ReadString( "GameServerSetup.txt", "MySQLUserName", "root" ),
%% 			MySQLPassword  = login_server:ini_ReadString( "GameServerSetup.txt", "MySQLPassword", "123" ),
%% 			MySQLPort  = login_server:ini_ReadInt( "GameServerSetup.txt", "MySQLPort", 3306 ),
%% 			MySQLDbName  = login_server:ini_ReadString( "GameServerSetup.txt", "MySQLDbName", "test" ),		
...
%% 				LogDbName  = login_server:ini_ReadString( "GameServerSetup.txt", "LogDbName", "fxserverlog" ),

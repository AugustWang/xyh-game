...
-define(OFFLINE_CACHE_TIME, 60000).
...
-define(CUR_GOLD, 1).     %% 货币类型金币
-define(CUR_DIAMOND, 2).  %% 货币类型钻石
-define(CUR_LUCK, 3).     %% 幸运星/类型
-define(CUR_HERO, 5).     %% 英雄/类型
-define(CUR_TIRED, 7).    %% 疲劳值/类型
-define(CUR_HORN, 8).     %% 喇叭/类型

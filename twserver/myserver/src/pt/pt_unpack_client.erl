...
p(11015, << VlistAL_:16,Vlist/binary >>) ->
    VlistF_ = fun({B_, R_}) ->
            << Vid1:8,Vvalue1:8,RB_/binary >> = B_, 
            {RB_, [[Vid1,Vvalue1]|R_]}
    end,
    {_, VlistR_} = protocol_fun:for(VlistAL_, VlistF_, {Vlist, []}),
    {ok, [VlistR_]};
...
p(13026, << Vcode:8,Vlevel:32,Vexp:32 >>) ->
    {ok, [Vcode,Vlevel,Vexp]};
...
p(13067, << Vcode:8,Vtime:32,Vcoin_time:32,Vlefttimes:8,VherosoulAL_:16,Vherosoul/binary >>) ->
    VherosoulF_ = fun({B_, R_}) ->
            << Vpos1:8,Vid1:32,Vtype1:8,Vrare1:8,RB_/binary >> = B_, 
            {RB_, [[Vpos1,Vid1,Vtype1,Vrare1]|R_]}
    end,
    {_, VherosoulR_} = protocol_fun:for(VherosoulAL_, VherosoulF_, {Vherosoul, []}),
    {ok, [Vcode,Vtime,Vcoin_time,Vlefttimes,VherosoulR_]};

p(_, <<>>) ->
    {ok, []};

p(13068, << Vcode:8,Vtime:32,Vnum:8,Vpos:8,Vid:32 >>) ->
    {ok, [Vcode,Vtime,Vnum,Vpos,Vid]};
...
p(14036, << Vcode:8,Vlevel:8,Vexp:32 >>) ->
    {ok, [Vcode,Vlevel,Vexp]};
...
p(14038, << Vcode:8,VheroesAL_:16,Vheroes/binary >>) ->
    VheroesF_ = fun({B_, R_}) ->
            << Vid1:32,Vstate1:8,RB_/binary >> = B_, 
            {RB_, [[Vid1,Vstate1]|R_]}
    end,
    {_, VheroesR_} = protocol_fun:for(VheroesAL_, VheroesF_, {Vheroes, []}),
    {ok, [Vcode,VheroesR_]};
...
p(22002, Bin) ->
    protocol_fun:unpack(22002, [int32,int16,int8,int8,[int8,int32,int32],[int8,int8,[int32],[int8,int32,int8,[int32]],int32],[int32,int8,int32],[int32,int32,int32,int8,int8,[int32,int32],int32,int32,int32,int32,int32,int32,int32,int32,int32,int32],[int32,int32,int8,int8,int32]], Bin);
...
p(25030, << Vcode:8,Vid:8,Vnum:32 >>) ->
    {ok, [Vcode,Vid,Vnum]};

p(_, <<>>) ->
    {ok, []};

p(25031, << Vcode:8,Vid:8,Vnum:32 >>) ->
    {ok, [Vcode,Vid,Vnum]};
...
p(34020, Bin) ->
    protocol_fun:unpack(34020, [[int32,int32,int8,int8,int8,int32,int32,int32,int32,int32,int32,int32,int32,int32,int32,int32,int32,int32,int32,int32],[int8,[int8,int32,int32],[int8,int8,[int32],[int8,int32,int8,[int32]],int32],[int32,int8,int32]]], Bin);
...
p(36003, << Vid:32,VnumAL_:16,Vnum/binary >>) ->
    VnumF_ = fun({B_, R_}) ->
            << Vtype1:32,Vnumber1:32,RB_/binary >> = B_, 
            {RB_, [[Vtype1,Vnumber1]|R_]}
    end,
    {_, VnumR_} = protocol_fun:for(VnumAL_, VnumF_, {Vnum, []}),
    {ok, [Vid,VnumR_]};
...
p(36005, Bin) ->
    protocol_fun:unpack(36005, [[int32,[int32,int32],int8]], Bin);

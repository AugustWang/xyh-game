...
class ChargeCallback extends Page
{
    ...
    {
        if($_REQUEST['act'] == 'xyh_a_360') return 'skip';
        ...
        if(count($myOrderData) == 4 
            ...
            // 安卓二服
            $servers['101']['node'] = 'mst_union_s2@10.6.12.248';
            $servers['101']['cookie'] = 'ewGEd3BEjDB0J1nE3puNBAQORNSQQfCO';
            // 一区体验服
            $servers['10002']['node'] = 'mengshoutang01@42.121.111.191';
            $servers['10002']['cookie'] = 'M2JmMTZhMmYzMzg1MTM0NTJmYjY2ZTIx';
            // 繁体
            $servers['200']['node'] = 'mst_2funfun0@192.168.0.246';
            $servers['200']['cookie'] = 'mst_2funfun0_26076116';
            // 繁体
            $servers['201']['node'] = 'a_fun_1@192.168.0.247';
            $servers['201']['cookie'] = 'MDhiYTY0ZGNiNjNjOTgxY2E1ZDk1NTc1';
            // xyh 体验服
            // $servers['1']['node'] = 'game_server@183.232.32.39';
            // $servers['1']['cookie'] = 'xyh26076116';

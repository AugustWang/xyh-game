...
p(11000, << Vtype:8,Vrand:32,Vsid:16,VplatformL_:16,Vplatform:VplatformL_/binary,VaccountL_:16,Vaccount:VaccountL_/binary,VpasswordL_:16,Vpassword:VpasswordL_/binary,VsignatureL_:16,Vsignature:VsignatureL_/binary >>) ->
    {ok, [Vtype,Vrand,Vsid,Vplatform,Vaccount,Vpassword,Vsignature]};
...
p(13026, << Vequid:32,Vjewtid:32,VidsAL_:16,Vids/binary >>) ->
    VidsF_ = fun({B_, R_}) ->
            << V01:32,RB_/binary >> = B_, 
            {RB_, [[V01]|R_]}
    end,
    {_, VidsR_} = protocol_fun:for(VidsAL_, VidsF_, {Vids, []}),
    {ok, [Vequid,Vjewtid,VidsR_]};

...
$(document).ready(function(){
	...
	GridView.init('.grid');
    //自动应用datepicker插件
    $('.datefield').css('width', '80px').datepicker({dateFormat:'yy-mm-dd'});
    $('.js_starttime').css('width', '120px').datepicker({dateFormat:'yy-mm-dd 00:00:00'});
    $('.js_endtime').css('width', '120px').datepicker({dateFormat:'yy-mm-dd 23:59:59'});

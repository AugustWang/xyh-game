...
// sign 签名 String
class Act_a_oppo extends ChargeCallback{
    ...
    public function process(){
        ...
        $this->setRequest();
        // Error Info
        $this->appIdErrorInfo = 'result=FAIL&resultMsg=AppId错误';
        $this->signErrorInfo = 'result=FAIL&resultMsg=Sign错误';
        $this->failedInfo = 'result=FAIL&resultMsg=错误';
        // Success Info
        $this->successInfo = 'result=OK&resultMsg=';
